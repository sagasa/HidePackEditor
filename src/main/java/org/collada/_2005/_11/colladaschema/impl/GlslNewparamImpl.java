...
public class GlslNewparamImpl implements GlslNewparam
{
    ...
    @XmlElement(type = GlslNewarrayTypeImpl.class)
    protected GlslNewarrayTypeImpl array;
    ...
    public void setArray(GlslNewarrayType value) {
        this.array = ((GlslNewarrayTypeImpl) value);
    }
