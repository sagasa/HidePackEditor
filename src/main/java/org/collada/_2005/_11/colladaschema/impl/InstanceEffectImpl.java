...
public class InstanceEffectImpl
    implements InstanceEffect
{

    @XmlElement(name = "technique_hint", type = InstanceEffectImpl.TechniqueHintImpl.class)
    protected List<InstanceEffect.TechniqueHint> techniqueHints;
    @XmlElement(name = "setparam", type = InstanceEffectImpl.SetparamImpl.class)
    ...
    public static class SetparamImpl
        implements InstanceEffect.Setparam
    {
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class TechniqueHintImpl
        implements InstanceEffect.TechniqueHint
    {
