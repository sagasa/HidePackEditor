    ...
    implements Geometry
{
    ...
    @XmlElement(type = SplineImpl.class)
    protected SplineImpl spline;
    @XmlElement(type = MeshImpl.class)
    protected MeshImpl mesh;
    @XmlElement(name = "convex_mesh", type = ConvexMeshImpl.class)
    protected ConvexMeshImpl convexMesh;
    ...
    public void setConvexMesh(ConvexMesh value) {
        this.convexMesh = ((ConvexMeshImpl) value);
    }
