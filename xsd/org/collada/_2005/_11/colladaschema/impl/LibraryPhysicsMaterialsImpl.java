...
public class LibraryPhysicsMaterialsImpl implements LibraryPhysicsMaterials
{

    @XmlElement(type = AssetImpl.class)
    protected AssetImpl asset;
    @XmlElement(name = "physics_material", required = true, type = PhysicsMaterialImpl.class)
