...
public class CgNewparamImpl implements CgNewparam
{
    ...
    @XmlElement(type = CgNewarrayTypeImpl.class)
    protected CgNewarrayTypeImpl array;
    ...
    public void setArray(CgNewarrayType value) {
        this.array = ((CgNewarrayTypeImpl) value);
    }
