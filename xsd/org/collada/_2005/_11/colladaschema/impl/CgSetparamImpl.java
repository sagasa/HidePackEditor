...
public class CgSetparamImpl implements CgSetparam
{

    @XmlElement(name = "connect_param", type = CgConnectParamImpl.class)
    protected CgConnectParamImpl connectParam;
    @XmlElement(type = CgSetarrayTypeImpl.class)
    protected CgSetarrayTypeImpl array;
    @XmlElement(type = CgSetuserTypeImpl.class)
    protected CgSetuserTypeImpl usertype;
    ...
    public void setConnectParam(CgConnectParam value) {
        this.connectParam = ((CgConnectParamImpl) value);
    }
    ...
    public void setArray(CgSetarrayType value) {
        this.array = ((CgSetarrayTypeImpl) value);
    }
    ...
    public void setUsertype(CgSetuserType value) {
        this.usertype = ((CgSetuserTypeImpl) value);
    }
